<script>
    ...
    let productosLista = [
        ...
        { id: 'RESUELTO', estado: 'RESUELTO' },
        { id: 'RECHAZADO', estado: 'RECHAZADO' }
    ];
    ...
    async function obtenerPromocionesProductos() {
        try {
            const resProductos = await fetch(`${pathUsuariosMS}/admin/quejas`, {
                method: 'GET',
                headers: {
    ...
    async function guardarProducto() {
        try {
            const url = `${pathUsuariosMS}/admin/quejas`;
            ...
            const response = await fetch(url, {
                ...
                body: JSON.stringify({ id_queja: body.id_queja, estado: body.estado })
            });
...
<svelte:head>
    <title>Seguimiento Usuarios</title>
</svelte:head>

<div class="productos-container {$darkMode ? 'dark-mode' : ''}">
    <div class="header-container">
        <h2>Seguimiento Usuarios</h2>
    </div>
...
<div class="modal-overlay {$darkMode ? 'dark-mode' : ''}">
    <div class="modal-content">
        ...
        <h3>Editar Estado Queja [ {productoEditando.id_queja} ]</h3>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    type="text"
                    disabled 
                    value={productoEditando.username}
                    required
                />
            </div>
