...
const { DATABASE_HOST, DATABASE_MYSQL_USER, DATABASE_MYSQL_PASSWORD, TABLE_FAVORITOS } = require('../config/env/db.config');
const { pool } = require('../config/db');

const sequelize = new Sequelize(TABLE_FAVORITOS, DATABASE_MYSQL_USER, DATABASE_MYSQL_PASSWORD, {
    host: DATABASE_HOST,
    dialect: 'mysql',
    logging: false,
    pool: {
...
const Favoritos = require('./templates/favoritos.model')(sequelize, DataTypes);
