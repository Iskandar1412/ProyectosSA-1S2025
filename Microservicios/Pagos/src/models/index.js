...
const { DATABASE_HOST, DATABASE_MYSQL_USER, DATABASE_MYSQL_PASSWORD, TABLE_PAGOS } = require('../config/env/db.config');

const sequelize = new Sequelize(TABLE_PAGOS, DATABASE_MYSQL_USER, DATABASE_MYSQL_PASSWORD, {
    host: DATABASE_HOST,
    dialect: 'mysql',
    logging: false,
    pool: {
...
const Pagos = require('./templates/pagos.model')(sequelize, DataTypes);
